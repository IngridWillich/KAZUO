...
const teamMembers = [
  { country: 'Argentina', members: [ 'Defillipi Antonella',  "Olmos Lautaro", "Willich Ingrid"], coordinates: [-38.4161, -63.6167] },
  { country: 'Bolivia', members: ['Saul Ortiz'], coordinates: [-16.2902, -63.5887] },
  { country: 'México', members: ['Arturo Guzman'], coordinates: [23.6345, -102.5528] },
  { country: 'Colombia', members: ['Fredy Rigueros'], coordinates: [4.5709, -74.2973] },
];
  ...
  return (
    <div className="bg-gray-60 text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl text-blue-600 font-bold mb-8 text-center">Nuestro Equipo Global</h2>
              ...
              {teamMembers.map((location) => (
                <div
                  ...
                  className={`bg-white text-gray-600 p-4 rounded-lg cursor-pointer transition-all duration-300 shadow-lg shadow-gray-500 ${
                    activeCountry.country === location.country ? 'ring-2 ring-blue-500' : ''
                  }`}
