...
//         setErrors(currentErrors); // los caracteres
...
//             //     Swal.fire({
//             //         title: 'Error',
//     //         //         text: 'Credenciales incorrecta. Por favor, inténtalo de nuevo.',
//     //         //         icon: 'error',
//     //         //         confirmButtonText: 'Aceptar'
//     //             });
//     //         }
...
//                         className={`w-full py-2 px-4 text-white ${isButtonDisabled ? 'bg-gray-400 cursor-not-allowed' : ' bg-gray-900  hover:bg-gray-800'} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 rounded-md`}
//                     >
//                         Iniciar Sesión
//                     </button>
//                 </form>
//                 <p className="text-center text-sm text-gray-600">
//                     ¿No tienes una cuenta? <Link href="/register" className="text-indigo-400 hover:text-indigo-500">Regístrate aquí</Link>
//                 </p>
//             </div>
//         </div>
//     );
