            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3">Cap. Max</th>
                ...
                {filteredProducts.length > 0 ? (
                  filteredProducts.map((product) => (
                    <tr key={product.id} className="border-b">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">{product.unids}</td>
                      <td className="px-6 py-4 whitespace-nowrap">{product.maxCapacity}</td>
                      <td className="px-6 py-4 whitespace-nowrap">{product.inPrice}</td>
                      <td className="px-6 py-4 whitespace-nowrap">{product.bange}</td>
                      <td className="px-6 py-4 whitespace-nowrap">{product.outPrice}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-red-600 font-bold">{product.minStock}</td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <td className="grid grid-cols-2 grid-rows-2 gap-6 py-2 text-center">
                          ...
                          />                          
                          <FontAwesomeIcon icon={faPlus} className="text-yellow-500 hover:text-yellow-600" onClick={()=>handleAddProduct(product.id!)} />
                          <FontAwesomeIcon icon={faMinus} className="text-red-500 hover:text-red-600"  onClick={() => handleNewOrderProduct(product.id!)}  />
                        </td>
                        </div>
                      </td>
                    </tr>
